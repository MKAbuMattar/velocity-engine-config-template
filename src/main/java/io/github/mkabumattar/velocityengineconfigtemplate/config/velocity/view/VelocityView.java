...
public class VelocityView extends AbstractTemplateView {
    ...
    protected VelocityEngine autodetectVelocityEngine() throws BeansException {
        try {
            VelocityConfiguration velocityConfiguration = BeanFactoryUtils.beanOfTypeIncludingAncestors(
                    getApplicationContext(), VelocityConfiguration.class, true, false);
            return velocityConfiguration.getVelocityEngine();
